import { Alert, Box, Button, CircularProgress, Grid, List, ListItem, MenuItem, Rating, Select, Typography } from '@mui/material';
               ...
               <ListItem>
                 <Box sx={classes.fullWidth}>
                    ...
                    <Select fullWidth value ={price} onChange={priceHandler}>
                        <MenuItem value="all">All</MenuItem>
                        {prices.map((price) => (
                            <MenuItem key={price.value} value={price.value}>{price.name}</MenuItem>
                         ))}
                    </Select>
                 </Box>
               </ListItem> 
